...
being replaced but not frozen — keep both compiling. `docs/` is a generated mockup.
...
route, a bundle config or a platform split: `npm run build:web`, serve `dist/` with
clean-URL mapping, open it. After layout: screenshot it and look
