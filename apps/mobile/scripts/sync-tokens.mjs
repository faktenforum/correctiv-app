/**
 * Converts tokens/theme.css (vendored from wp-design-tokens) into NativeScript SCSS.
 *
...
// The source is tokens/theme.css in this repo (see tokens/README.md); resolution
// lives in scripts/tokens-source.mjs rather than here.
const SRC = themeCssPath();
...
const banner = `// GENERATED by scripts/sync-tokens.mjs from tokens/theme.css
