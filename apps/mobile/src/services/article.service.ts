...
import { getCached, getStale, setCached } from '@correctiv/app-core/services/cache.service';
import { extractArticle, extractMeta, readingMinutes } from '@correctiv/app-core/lib/extract.mjs';
